...
* There are results
    * yep (1P)
* Results are reported and visualized appropiately
    * yep, but assumptions before testing everything are missing (1.5P) 


## 2. Gathering a Dataset (4/4P)
* Sufficient images captured 
    * yep (facial expression matches us correcting all assignments in this heat :D) (1P)
...
## 3. Gesture-based Media Controls (5.5/6P)
